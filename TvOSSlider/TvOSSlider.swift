...
open class TvOSSlider: UIControl {
    // MARK: - open
    ...
    @IBInspectable
    open var minimumValue: Float = defaultMinimumValue {
        didSet {
    ...
    @IBInspectable
    open var maximumValue: Float = defaultMaximumValue {
        didSet {
    ...
    @IBInspectable
    open var isContinuous: Bool = defaultIsContinuous

    /// The color used to tint the default minimum track images.
    @IBInspectable
    open var minimumTrackTintColor: UIColor? = defaultMininumTrackTintColor {
        didSet {
    ...
    @IBInspectable
    open var thumbTintColor: UIColor = defaultThumbTintColor {
        didSet {
    ...
    @IBInspectable
    open var focusScaleFactor: CGFloat = defaultFocusScaleFactor {
        didSet {
    ...
    open var stepValue: Float = defaultStepValue
    ...
    open var storedValue: Float = defaultValue
    ...
    private func panGestureWasTriggered(panGestureRecognizer: UIPanGestureRecognizer) {
        if isVerticalGesture(panGestureRecognizer) {
            return
        }
